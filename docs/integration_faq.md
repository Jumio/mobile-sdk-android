...
| :------------------------------------------- |:--------:| :-----------------------------------------------------------------------------------------------: |
| Base                                         | 1.44 MB  |                                               core                                                |
| Base + Autocapture                           | 3.43 MB  |                                          core, docfinder                                          |
| Base + Autocapture, Barcode-Vision           | 3.74 MB  |                                  core, docfinder, barcode-mlkit                                   |
| Base + Autocapture, Barcode-Vision, Liveness | 6.40 MB  |                                core, docfinder, barcode, liveness                                 |
| Base + Autocapture, Barcode-Vision, NFC      | 7.41 MB  |                                   core, docfinder, barcode, nfc                                   |
| All (Custom UI only)                         | 10.74 MB |             core, docfinder, barcode-mlkit, nfc, digital-identity, camerax, liveness              |
| Base + Autocapture, Default UI               | 4.70 MB  |                                    core, docfinder, defaultui                                     |
| All (with Default UI)                        | 12.01 MB |       core, docfinder, barcode-mlkit, nfc, digital-identtity, camerax, defaultui, liveness        |
...
Google Play’s new app serving model uses the _App bundle_ to generate and serve optimized APKs for each user’s device configuration, so they download only the code and resources they need to run your app.

### Architectures, ABI Filters & Splitting

The SDK supports _armeabi-v7a_ and _arm64-v8a_ architecture. You can filter which architecture to use by specifying the abiFilters. That way, you could manually filter for _armeabi-v7a_ as _arm64-v8a_.

**Be aware:** As of August 2019, Google Play Console will require that new apps and app updates with native libraries provide 64-bit versions in addition to their 32-bit versions, as mentioned in the [Android developers blog.](https://android-developers.googleblog.com/2017/12/improving-app-security-and-performance.html).

⚠️&nbsp;__Note:__ The abiFilters command in the ndk closure affects the Google Play Store filtering.
...
If using Gradle 8, `fullMode` is _enabled per default_. You may disable it and use compatibility mode instead by putting the following in your `gradle.properties` file:
...
⚠️&nbsp;__Note:__ Please note that the method `showShutterButton()` does neither create nor display the actual shutter button!
...
<div style={{display: 'flex', gap: '10px'}}>
  <img src="images/capturing_methods/autocapture_01.jpg" alt="Autocapture Start" style={{width: '22%', height: 'auto'}} />
  <img src="images/capturing_methods/autocapture_02.jpg" alt="Autocapture Center Document" style={{width: '22%', height: 'auto'}} />
  <img src="images/capturing_methods/autocapture_03.jpg" alt="Autocapture Hold Still" style={{width: '22%', height: 'auto'}} />
  <img src="images/capturing_methods/autocapture_04.jpg" alt="Autocapture Checking Image" style={{width: '22%', height: 'auto'}} />
</div>
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img src={require('./images/capturing_methods/manual_capturing_01.jpg').default} alt="Manual Capture Empty" style={{width: '38%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/manual_capturing_02.jpg').default} alt="Manual Capture Document" style={{width: '38%', height: 'auto'}} />
</div>
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img
    src={require('./images/enhanced_injection_detection/enhanced_injection_detection_white_balance.jpg').default}
    alt="enhanced_injection_detection_white_balance"
    style={{width: '38%', height: 'auto'}}
  />
  <img
    src={require('./images/enhanced_injection_detection/enhanced_injection_detection_focus.jpg').default}
    alt="enhanced_injection_detection_focus"
    style={{width: '38%', height: 'auto'}}
  />
</div>
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img src={require('./images/capturing_methods/nfc_scanning_01.jpg').default} alt="NFC Help" style={{width: '38%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/nfc_scanning_02.jpg').default} alt="NFC Scanning" style={{width: '38%', height: 'auto'}} />
</div>

#### Linefinder (deprecated)

**_As of SDK version 4.7.0 this module has been deprecated. Please use [Autocapture](https://github.com/Jumio/mobile-sdk-android/blob/master/docs/integration_faq.md#autocapture)
instead._**
Scanning using edge detection.

<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img src={require('./images/capturing_methods/linefinder_scanning_01.jpg').default} alt="Linefinder Empty" style={{width: '32%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/linefinder_scanning_02.jpg').default} alt="Linefinder Document" style={{width: '32%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/linefinder_scanning_03.jpg').default} alt="Linefinder Processing" style={{width: '32%', height: 'auto'}} />
</div>
#### MRZ (deprecated)
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img src={require('./images/capturing_methods/mrz_scanning_01.jpg').default} alt="MRZ Empty" style={{width: '48%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/mrz_scanning_02.jpg').default} alt="MRZ Document" style={{width: '48%', height: 'auto'}} />
</div>
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap'}}>
  <img src={require('./images/capturing_methods/barcode_scanning_01.jpg').default} alt="Barcode Empty" style={{width: '48%', height: 'auto'}} />
  <img src={require('./images/capturing_methods/barcode_scanning_02.jpg').default} alt="Barcode Document" style={{width: '48%', height: 'auto'}} />
</div>
...
...
    packagingOptions {
		...
		resources.excludes.add("concurrentMain/**/*")
		resources.excludes.add("webMain/**/*")
    	...
    }
}
```
