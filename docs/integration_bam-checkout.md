...
__Note:__ You can find your customer API token and API secret in the Customer Portal on the Settings page under **API credentials**. We strongly recommend that you store credentials outside your app.
